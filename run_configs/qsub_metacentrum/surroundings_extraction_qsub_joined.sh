...
python3 src/dataset/surroundings_calculation/extract_surroundings.py joined
cp -r data/surroundings /storage/brno12-cerit/home/eleniel/refined/joined_result
